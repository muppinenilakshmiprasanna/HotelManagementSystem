...
class ViewHotelDetails(unittest.TestCase):
    ...
    def test_hotelslist(self):
        ...
        time.sleep(1)
        BookRoom=driver.find_element_by_xpath("/html/body/div/div[2]/p[10]/a").click()
        bookroomele = driver.find_element_by_id("id_guestFirstName")
        bookroomele.send_keys( "Prasanna")
        bookroomele = driver.find_element_by_id("id_guestLastName")
        bookroomele.send_keys("Muppineni")
        bookroomele = driver.find_element_by_id("id_email")
        bookroomele.send_keys("lmuppineni@unomaha.edu")
        bookroomele = driver.find_element_by_id("id_phonenumber")
        bookroomele.send_keys("4029064787")
        bookroomele = driver.find_element_by_id("id_CheckIn")
        bookroomele.send_keys("05/11/2020")
        bookroomele = driver.find_element_by_id("id_CheckOut")
        bookroomele.send_keys("05/15/2020")
        bookroombutton=driver.find_element_by_xpath("/html/body/div[1]/form/button").click()
        time.sleep(1)
