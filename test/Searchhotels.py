...
class Searchhotels(unittest.TestCase):
    ...
    def test_serach(self):
        ...
        time.sleep(1)
        serachhotelsbutton=driver.find_element_by_xpath("/html/body/nav/div/div[2]/ul[2]/li[2]/a").click()
        serachelem = driver.find_element_by_name("searchitem")
        serachelem.send_keys(searchtext)
        time.sleep(1)
        serachelem.send_keys(Keys.RETURN)
        assert "Searched sucessfully"
        time.sleep(1)
